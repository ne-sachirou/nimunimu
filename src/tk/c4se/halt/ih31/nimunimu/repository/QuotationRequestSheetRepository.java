 ...
 * 
 */
public class QuotationRequestSheetRepository extends
		RdbRepository<QuotationRequestSheet> {
	private static final long serialVersionUID = 1L;

	public QuotationRequestSheetRepository() {
		super();
	}
	 ...
	 */
	public QuotationRequestSheet find(int id) throws DBAccessException {
		if (id == 0) {
			return null;
		}
		...
		try (val connection = DBConnector.getConnection()) {
			...
			if (result.next()) {
				sheet = new QuotationRequestSheet();
	 ...
	 * @throws DBAccessException
	 */
	public QuotationRequestSheet find(String idStr) throws DBAccessException {
		final int id;
		try {
	 ...
	 * @throws DBAccessException
	 */
	public List<QuotationRequestSheet> all(int page) throws DBAccessException {
		val sql = "select * from customer_order_sheet where deleted_at = null and rownum between ? and ?";
		List<QuotationRequestSheet> sheets = new ArrayList<>();
		try (val connection = DBConnector.getConnection()) {
			@Cleanup
			PreparedStatement statement = connection.prepareStatement(sql);
	 ...
	 * @throws DBAccessException
	 */
	public List<QuotationRequestSheet> all() throws DBAccessException {
	...
	public void insert(QuotationRequestSheet sheet) throws DBAccessException {
	...
	public void update(QuotationRequestSheet sheet) throws DBAccessException {
	...
	public void delete(QuotationRequestSheet sheet) throws DBAccessException {
	...
	@Override
	protected QuotationRequestSheet setProperties(QuotationRequestSheet sheet,
